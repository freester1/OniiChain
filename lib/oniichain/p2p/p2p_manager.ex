defmodule Oniichain.P2pManager do
  alias Poison, as: JSON
  @moduledoc """
    Manages the p2p connections for this onii-chain instance
  """

  def start_link(sender_pid, destination_url, headers \\ []) do
    :crypto.start
    :ssl.start
    :websocket_client.start_link(String.to_char_list(destination_url), __MODULE__, [sender_pid],
  ...
  # Websocket client callbacks, called within the context of the websocket client
  def init([sender], _conn_state) do
    {:ok, %{sender: sender, ref: 0}}
  end
